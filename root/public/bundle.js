...
function (_Component) {
  ...
  _createClass(Movie, [{
    ...
    value: function render() {
      ...
      if (error) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, error.message);
      }
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, movies.map(function (movie) {
        return (// Without the `key`, React will fire a key warning
          react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
            key: movie._id
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, movie.Title), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
            src: movie.Poster
          }))
        );
      }));
